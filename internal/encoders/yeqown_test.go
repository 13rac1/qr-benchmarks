...
func TestYeqownEncoder_Encode_EmptyData(t *testing.T) {
	enc := &YeqownEncoder{}
	data := []byte{}
...
func TestYeqownEncoder_Encode_ErrorCorrectionLevels(t *testing.T) {
	enc := &YeqownEncoder{}
...
func TestYeqownEncoder_Encode_VariousDataSizes(t *testing.T) {
	enc := &YeqownEncoder{}
...
func TestYeqownEncoder_Encode_DifferentPixelSizes(t *testing.T) {
	enc := &YeqownEncoder{}
