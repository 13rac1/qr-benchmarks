...
func TestGozxingEncoder_Encode_EmptyData(t *testing.T) {
	enc := &GozxingEncoder{}
	data := []byte{}
...
func TestGozxingEncoder_Encode_ErrorCorrectionLevels(t *testing.T) {
	enc := &GozxingEncoder{}
...
func TestGozxingEncoder_Encode_VariousDataSizes(t *testing.T) {
	enc := &GozxingEncoder{}
...
func TestGozxingEncoder_Encode_DifferentPixelSizes(t *testing.T) {
	enc := &GozxingEncoder{}
